...
Route::group(['prefix' => 'install','as' => 'elimuswift.installer','namespace' => 'Elimuswift\Installer\Controllers','middleware' => ['web', 'install']], function() {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update','as' => 'LaravelUpdater::','namespace' => 'Elimuswift\Installer\Controllers','middleware' => 'web'],function() {

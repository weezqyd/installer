        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ isActive('elimuswift.installerfinal') }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('elimuswift.installerenvironment')}} {{ isActive('elimuswift.installerenvironmentWizard')}} {{ isActive('elimuswift.installerenvironmentClassic')}}">
                        @if(Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('elimuswift.installerenvironment') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('elimuswift.installerpermissions') }}">
                        @if(Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('elimuswift.installerpermissions') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('elimuswift.installerrequirements') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('elimuswift.installerrequirements') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('elimuswift.installerwelcome') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('elimuswift.installerwelcome') }}">

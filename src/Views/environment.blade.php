...
@section('container')
    ...
    <div class="buttons">
        <a href="{{ route('elimuswift.installerenvironmentWizard') }}" class="button button-wizard">
            <i class="fa fa-sliders fa-fw" aria-hidden="true"></i> {{ trans('installer_messages.environment.menu.wizard-button') }}
        </a>
        <a href="{{ route('elimuswift.installerenvironmentClassic') }}" class="button button-classic">
